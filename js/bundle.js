(function () {
    ...
    class GameUI extends ui.test.TestSceneUI {
        constructor() {
            ...
            camera.transform.translate(new Laya.Vector3(0, 0.5, 1.7));
            ...
            Laya.Texture2D.load("res/earth.png", Laya.Handler.create(null, function (tex) {
            ...
            earth.transform.localScale = new Laya.Vector3(0.6, 0.6, 0.6);
            Laya.timer.frameLoop(1, this, function () {
                earth.transform.rotate(new Laya.Vector3(0, 0.01, 0), true);
            });
        }
        initShader() {
            var attributeMap = {
